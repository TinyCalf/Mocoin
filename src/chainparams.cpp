...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("049e02fa9aa3c19a3b112a58bab503c5caf797972f5cfe1006275aa5485a01b48f9f648bc5380ee1e82dc6f474c8e0f7e2f6bbd0de9355f92496e3ea327ccb19cc") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8"); //BTC
        //consensus.BIP34Hash = uint256S("0xfffffffffffff24b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8"); //Jonathan MBC
        ...
        //consensus.powLimit = uint256S("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");//Jonathan MBC
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008 BTC
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008 BTC
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000003f94d1ad391682fe038bf5"); //BTC
        //consensus.nMinimumChainWork = uint256S("0x0fffffffffffffffffffffffffffffffffffffffff3f94d1ad391682fe038bf5"); //Jonathan MBC

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000000000000000013176bf8d7dfeab4e1db31dc93bc311b436e82ab226b90"); //453354 BTC
        //consensus.defaultAssumeValid = uint256S("0x0fffffffffffffffff13176bf8d7dfeab4e1db31dc93bc311b436e82ab226b90"); //Jonathan MBC
        ...
        //genesis = CreateGenesisBlock(1497866960, 0, 0x1e090000, 1, 200 * COIN);//Jonathan MBC
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000000061b1aca334b059920fed7bace2336ea4d23d63428c7aee04da49e942")); //Jonathan MBC
        assert(genesis.hashMerkleRoot == uint256S("0x7bf229f629a6666596c1ce57117c28d1d29299e8a5303347929bd70847c49adb")); //Jonathan MBC
