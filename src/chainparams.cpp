...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 2462060800; //Jonathan 暂时未知其具体影响，改大一点避免问题
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 2493596800; //Jonathan 暂时未知其具体影响，改大一点避免问题

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 2479168000; //Jonathan 暂时未知其具体影响，改大一点避免问题
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 100; //Jonathan 测试网减半区块周期
