...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Ebocoin Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Ebocoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Ebocoin Core developers";
    }
