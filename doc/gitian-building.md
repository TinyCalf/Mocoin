...
*Setup instructions for a Gitian build of Tcash Core using a Debian VM or physical system.*
...
- [Building Tcash Core](#building-bitcoin-core)
...
To build Tcash Core (for Linux, OS X and Windows) just follow the steps under 'perform
