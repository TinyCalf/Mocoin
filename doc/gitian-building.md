...
*Setup instructions for a Gitian build of Ebocoin Core using a Debian VM or physical system.*
...
- [Building Ebocoin Core](#building-bitcoin-core)
...
To build Ebocoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
