Tcash Core version 0.13.0 is now available from:
...
Various code modernizations have been done. The Tcash Core code base has
...
HD wallets are incompatible with older versions of Tcash Core.
...
proposed parameters, a future release of Tcash Core is expected that
