Ebocoin Core version 0.13.0 is now available from:
...
Various code modernizations have been done. The Ebocoin Core code base has
...
HD wallets are incompatible with older versions of Ebocoin Core.
...
proposed parameters, a future release of Ebocoin Core is expected that
